...
i_cha <- read_all_sheets("Input data/2.2_Community_Hubs_and_Assessment.xlsx")
...
write.csv(g_cha, glue("Test output/AssessmentHub.csv"), row.names = FALSE)
...
write.csv(g_agesexdata, glue("Test output/AssessmentHub_AgeSex.csv"), row.names = FALSE)
...
write.csv(deprivation, glue("Test output/AssessmentHub_SIMD.csv"), row.names = FALSE)
