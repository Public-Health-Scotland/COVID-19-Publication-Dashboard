...
i_cccc <- read_all_excel_sheets(glue(input_data, "Contact Tracing/{format(report_date -2,'%Y%m%d')}_case_created_case_closed.xlsx"))
i_ccic <- read_all_excel_sheets(glue(input_data, "Contact Tracing/{format(report_date -2,'%Y%m%d')}_case_created_to_interview_completed.xlsx"))
i_casi <- read_all_excel_sheets(glue(input_data, "Contact Tracing/{format(report_date -2,'%Y%m%d')}_contacts_advised_to_self_isolate.xlsx"))
i_ctp <- read_all_excel_sheets(glue(input_data, "Contact Tracing/{format(report_date -2,'%Y%m%d')}_contacts_testing_positive.xlsx"))
i_ct <- read_all_excel_sheets(glue(input_data, "Contact Tracing/{format(report_date -2,'%Y%m%d')}_cumulative_totals.xlsx"))
i_teic <- read_all_excel_sheets(glue(input_data, "Contact Tracing/{format(report_date -2,'%Y%m%d')}_test_effective_to_interview_completed.xlsx"))
i_wco <- read_all_excel_sheets(glue(input_data, "Contact Tracing/{format(report_date -2,'%Y%m%d')}_weekly_cms_output.xlsx"))
i_wfr <- read_all_excel_sheets(glue(input_data, "Contact Tracing/{format(report_date -2,'%Y%m%d')}_weekly_failed_reasons_output.xlsx"))
